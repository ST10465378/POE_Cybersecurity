...
{//start of namespace
    ...
    {//start of class
        ...
        {//start of method
            ...
            welcome_and_username.TypeWrite("  Dynabot : Ask me anything, " + username + ". Type 'exit' to quit.", ConsoleColor.Blue);
            Console.WriteLine();
            ...
            do
            {
                ...
                {
                    welcome_and_username.TypeWrite("  Dynabot : You didn't type anything. Could you rephrase?", ConsoleColor.Red);
        ...
        {//start of method
            ...
            {
                Console.WriteLine();
                welcome_and_username.TypeWrite("  Dynabot : Goodbye! Stay safe online. 🔒", ConsoleColor.Yellow);
                Console.ForegroundColor = ConsoleColor.Cyan;
                Console.WriteLine("  ══════════════════════════════════════");
                Console.ResetColor();
            ...
            else
            {
                ...
                foreach (string word in words)
                {
                    ...
                    foreach (string answer in answers)
                    {
                        ...
                        {
                            welcome_and_username.TypeWrite("  Dynabot : " + answer, ConsoleColor.Green);
                            matched = true;
                            break;
                        }
                    }
